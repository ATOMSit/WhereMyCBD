        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
            ...
            <div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
                <div class="kt-login__head">
                    ...
                    <a href="{{route('admin.login')}}" class="kt-link kt-login__signup-link">
                        Connectez-vous !
                    </a>
                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    {!! form_row($form->first_name,$options=['label_show'=>false,'attr'=>['placeholder'=>'Prénom']]) !!}
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    {!! form_row($form->last_name,$options=['label_show'=>false,'attr'=>['placeholder'=>'Nom de famille']]) !!}
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            {!! form_row($form->email,$options=['label_show'=>false,'attr'=>['placeholder'=>'Adresse mail']]) !!}
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    {!! form_row($form->password_confirmation,$options=['label_show'=>false,'attr'=>['placeholder'=>'Confirmation']]) !!}
                                </div>
                            </div>
                        </div>
